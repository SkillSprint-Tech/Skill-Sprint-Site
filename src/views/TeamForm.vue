<template>
  <div ref="formScope" class="min-h-screen bg-[#F8FAFC] text-gray-950 py-20 px-4 font-sans overflow-hidden">
    <div class="max-w-2xl mx-auto relative">
      ...
      <!-- Back Link -->
      <router-link to="/team" class="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 text-sm font-semibold mb-8 group transition relative z-10">
        <span>←</span> <span class="group-hover:translate-x-0.5 transition-transform duration-200">Back to Team Page</span>
      </router-link>

      <!-- Form Container Card -->
      <div class="bg-white rounded-[2.5rem] p-8 sm:p-12 border border-gray-100 shadow-2xl relative overflow-hidden form-container relative z-10 hover:border-blue-300/20 transition-all duration-500">
        <!-- Success State -->
          ...
          <form v-else @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="flex flex-col gap-2">
              ...
              <input 
                ...
                required
                class="w-full px-4 py-3.5 bg-slate-50/50 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition text-sm font-medium text-gray-900 placeholder-gray-400"
              />
            </div>
            ...
            <div class="flex flex-col gap-2">
              ...
              <textarea 
                ...
                required
                maxlength="140"
                class="w-full px-4 py-3.5 bg-slate-50/50 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition text-sm font-medium text-gray-900 placeholder-gray-400 resize-none"
              ></textarea>
            ...
            <div class="flex flex-col gap-2">
              ...
              <div 
                class="border-2 border-dashed border-gray-200 rounded-2xl p-6 text-center hover:border-blue-400 hover:bg-blue-50/5 transition cursor-pointer relative"
              ...
              >
                ...
                <div v-else class="flex flex-col items-center gap-3">
                  <div class="w-20 h-20 rounded-2xl overflow-hidden border border-gray-200 bg-slate-50 relative group">
